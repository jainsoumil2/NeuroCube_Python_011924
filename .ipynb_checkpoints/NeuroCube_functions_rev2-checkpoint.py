...
def write_external_DACs_neurodyn(dev, ch, value, which_neurodyn):
    ...
    if 0 <= ch <= 15:
        ...
        write_Gap_Junction(dev, which_neurodyn + 1,
                           0x5C00)  # options for which_neurodyn -- 0, 1, 2, 3; enable chip select of 'which_neurodyn' -- port 28 of MAX7301AAX+ outputs logic 0, ports 29-31 output logic 0
        write_FPGA_NC(dev, NC_DAC_flag_addr, 0x02)  # 0x02 will select V DAC
        ...
        while True:
            ...
            if done == 1:
                ...
                # AU: 1/13/23: offset which_neurodyn by 1 to remain uniform indexing of 0-3
                write_Gap_Junction(dev, which_neurodyn + 1,
                                   0x5C01)  # options for which_neurodyn -- 0, 1, 2, 3; disable chip select of 'which_neurodyn' -- port 28 of MAX7301AAX+ outputs logic 1, ports 29-31 output logic 0
