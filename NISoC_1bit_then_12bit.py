...
Clock delay sign:       1 (positive delay).
Clock low time:         3,999*10ns = 39.99us.s
...
'Clock Enable' register contents:
...
'''
Clock settings for config write FSM:
Clock address:          11.
...
[0] 0 = Voltage clamping, 1 = Current Clamping; 
[1] 0 = Single CDS, 1 = Double CDS; 
[2] 0 = Single conv, 1 = full conv; 
[3] Gain<0>; [4] Gain<1>; [5] Gain<2>; 
[6] BW<0>; [7] BW<1>; [8] BW<2>; 
[9] EXT_RES; 
[10] EXT_STAYB; 
[11] OVERRIDE;
[12] OverflowEN; 
[13] RST command 0; [14] RST command 1; 
[15] 1 = global, 0 = Local.

Example global configurations: '1001_1110_0000_0101'  # default configuration, CC
...
Some more configuration codes from Akshay's old Python:
if full_conv:
...
[0] Al, [1] Pl, 
[2:5] strt_indx, 
[6] AmpSense, [7] InfinImpSense,
[8] AmpOverwrite, [9] InfinImpOverwrite, 
[10] Channel_off, [11] ADC_off, 
[12:14] N/A, 
[15] 1 = global, 0 = local.
'''
