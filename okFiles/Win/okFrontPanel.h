...
#define OK_PRODUCT_XEM8370KU11P     (59)
...
enum okEProduct {
	...
	okPRODUCT_XEM8370KU11P = OK_PRODUCT_XEM8370KU11P,
...
#define OK_API_VERSION_MICRO 1

#define OK_API_VERSION_STRING "5.3.1"
...
okDLLEXPORT ok_ErrorCode DLL_ENTRY
okFrontPanel_WriteI2C(okFrontPanel_HANDLE hnd, int addr, int length, const unsigned char* data);
okDLLEXPORT ok_ErrorCode DLL_ENTRY
okFrontPanel_ReadI2C(okFrontPanel_HANDLE hnd, int addr, int length, unsigned char* data);
okDLLEXPORT ok_ErrorCode DLL_ENTRY
...
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_ClearFPGAConfiguration(okFrontPanel_HANDLE hnd);
okDLLEXPORT ok_ErrorCode DLL_ENTRY
...
okDLLEXPORT ok_ErrorCode DLL_ENTRY okFrontPanel_ConfigureFPGAFromMemory(
	okFrontPanel_HANDLE hnd, const unsigned char* data, unsigned long length
);
...
okDLLEXPORT long DLL_ENTRY okFrontPanel_WriteToPipeIn(
	okFrontPanel_HANDLE hnd, int epAddr, long length, const unsigned char* data
);
...
okDLLEXPORT long DLL_ENTRY okFrontPanel_WriteToBlockPipeIn(
	okFrontPanel_HANDLE hnd, int epAddr, int blockSize, long length, const unsigned char* data
);
...
public:
	...
	ErrorCode ConfigureFPGAFromMemoryWithReset(
		const unsigned char* data, unsigned long length, const okTFPGAResetProfile* reset
	);
...
// Convenient alias.
using FrontPanelPtr = std::unique_ptr<OpalKellyLegacy::okCFrontPanel>;
...
inline okCFrontPanel::ErrorCode
okCFrontPanel::ClearFPGAConfiguration()
{
	return ((okCFrontPanel::ErrorCode)okFrontPanel_ClearFPGAConfiguration(h));
}
inline okCFrontPanel::ErrorCode
...
okCFrontPanel::ConfigureFPGAFromMemory(
	const unsigned char* data, unsigned long length, OpalKelly::ProgressCallback* callback
)
{
	ok_ErrorCode ec;
	if (callback) {
...
inline okCFrontPanel::ErrorCode
okCFrontPanel::WriteI2C(int addr, int length, const unsigned char* data)
{
	return ((okCFrontPanel::ErrorCode)okFrontPanel_WriteI2C(h, addr, length, data));
}
inline okCFrontPanel::ErrorCode
okCFrontPanel::ReadI2C(int addr, int length, unsigned char* data)
{
...
inline long
okCFrontPanel::WriteToPipeIn(int epAddr, long length, const unsigned char* data)
{
...
inline long
okCFrontPanel::WriteToBlockPipeIn(int epAddr, int blockSize, long length, const unsigned char* data)
{
