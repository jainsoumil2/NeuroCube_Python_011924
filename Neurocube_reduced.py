...
write_external_DACs_neurodyn(dev, IinCurrentPin, 0.525, neurodyn_sel+1)   # socket 1 - 0.6211v -- 40nA        
write_external_DACs_neurodyn(dev, IinRefPin, 0.58, neurodyn_sel+1)       # socket 1 - 0.4422v -- 0.4nA       
...
parms['biasgErev'][0][0] = [[gNa, ENa], [gK, EK], [gL, EL]]                                     # Neuron 1 -- parms['biasgErev'][0][0][0][0] -- sodium maximal conductance, parms['biasgErev'][0][0][0][1] -- sodium maximal reversal potential, parms['biasgErev'][0][0][1][0] -- potassium maximal conductance, parms['biasgErev'][0][0][1][1] -- sodium reversal potential, parms['biasgErev'][0][0][2][0] -- leak maximal conductance, parms['biasgErev'][0][0][2][1] -- leak reverse potential 
parms['signgErev'][0][0] = [[1, 1], [1, -1], [1, 1]]                                                # sign bits for the same as described in line 274
parms['biasgErev'][1][0] = [[gNa, ENa], [gK, EK], [gL, EL]]                                     # Neuron 2
parms['signgErev'][1][0] = [[1, 1], [1, -1], [1, 1]]
parms['biasgErev'][2][0] = [[gNa, ENa], [gK, EK], [gL, EL]]                                     # Neuron 3
parms['signgErev'][2][0] = [[1, 1], [1, -1], [1, 1]]
parms['biasgErev'][3][0] = [[gNa, ENa], [gK, EK], [gL, EL]]                                     # Neuron 4
...
parms['biasgErev'][0][1] = [[gSyn[0], 256], [gSyn[1], 256], [gSyn[2], 256]]
...
parms['biasgErev'][1][1] = [[gSyn[0], 256], [gSyn[1], 256], [gSyn[2], 256]]
parms['biasgErev'][2][1] = [[gSyn[0], 256], [gSyn[1], 256], [gSyn[2], 256]]
...
parms['biasgErev'][3][1] = [[gSyn[0], 800], [gSyn[1], 800], [gSyn[2], 256]]
...
for quadrantSel in [0, 1, 2, 3]: # for synapses
    load_int_dacs(dev, parms['signAlphaBeta'],
                  parms['signgErev'],
                  parms['biasAlphaBeta'],
                  parms['biasgErev'],
